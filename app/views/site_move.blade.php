...
@section('meta')
<title>Doolox Move Website</title>
<meta name="description" content="Doolox Move Website / Doolox is a free and Open Source WordPress management tool and website builder available both as a SaaS and for download.">
@stop
